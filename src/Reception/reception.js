...
const ReceptionPage = () => {
  ...
  useEffect(() => {
    ...
    if (token !== "reception") {
      navigate("/"); // Redirect to the home page if token is not "reception"
    }
  }, [navigate]);
  ...
  return (
    <div className="background">
      <div className="reception-container">
        <h2 className="reception-title">{i18n.t("patientRegistration")}</h2>
        <form className="reception-form" onSubmit={handleSubmit}>
          ...
          <label className="label-symptoms">{i18n.t("symptoms")}:</label>
          <textarea
            name="symptoms"
